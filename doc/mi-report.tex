...
\author{Lambrechts Nathan} % TODO
\email{nathan.lambrechts@student.unamur.be} % TODO

\author{Eben Edwyn} % TODO
\email{edwyn.eben@student.unamur.be} % TODO

\author{Mathieu Louca} % TODO
\email{mathieu.louca@student.unamur.be} % TODO

\author{Simon Dourte} % TODO
\email{simon.dourte@student.unamur.be} % TODO

\author{Florian Stormacq} % TODO
\email{florian.stormacq@student.unamur.be} % TODO
...
Describe the successive steps you have taken to achieve to your contribution. % TODO
